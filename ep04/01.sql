--ex 1:Qual o valor total de receita gerada por clientes de cada estado? Considere a base completa, com apenas pedidos entregues

select t2.customer_state,
        sum(t3.price) as receita_por_estado,
